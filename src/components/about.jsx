                                ...
                                <div className="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                                    <div className="col-md-12">
                                        <div className="about-desc">
                                            ...
                                            <p>Currently at Ford, I leverage my expertise to enhance software reliability and functional safety, specializing in the integration of compliance, functional safety tests, and automated security scans into CI/CD pipelines. My accomplishments also include designing and deploying a threat modeling app that automates the generation of attack trees, compliance reports, and data flow diagrams, available on my <a href="https://github.com/JeffinWithYa">GitHub</a>.</p>
